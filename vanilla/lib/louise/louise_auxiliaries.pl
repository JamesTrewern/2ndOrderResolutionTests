:-module(louise_auxiliaries, [% MIL problem auxiliaries
...
/** <module> Auxiliary predicates for Louise.

Predicates in this module support the implementation and usage of
Louise. They include predicates to examine an experiment file in the
format utiliesed in Louise.
...
list_encapsulated_problem(Ts):-
	louise_configuration:listing_limit(L)
...
edit_experiment_file:-
	louise_configuration:experiment_file(P,_M)
	,edit(P).
